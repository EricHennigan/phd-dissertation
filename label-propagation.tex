...
Of conspicuous absence in our guidelines (and the complete list of security bytecodes in \autoref{ch:instructions}) is an operation for pushing a specific security label onto the control flow stack.
