...
This work takes inspiration from the decentralized label model~\cite{decentralized-labels}.
...
As the interpreter executes, these joins steadily elevate the labels on objects within the system, a phenomenon known as \term{label creep}~\cite{creep}.
