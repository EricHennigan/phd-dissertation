...
\end{lstlisting}
  ...
  \label{list:boolean}
\end{figure}
\todo{apply better formatting to listings.}
...
Technical difficulties of the JavaScriptCore design prevented implementation of sparse labeling~\cite{sparse-labeling-flannagan} and forced conservative cloaking of primitive values.
