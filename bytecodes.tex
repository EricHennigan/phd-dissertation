...
Without upgrading this label, the \code{return} at line~\code{5} of Listing~\ref{list:steal-pin-bytecode} leaks the information of the secret variable \code{pin}.
