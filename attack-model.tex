\chapter{Code Injection Attacks}\label{ch:code-injection}

\section{Brief Overview of Web Architecture}\label{sec:web-architecture}
...
\section{The Many Types of XSS}\label{sec:xss-types}
