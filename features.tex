...
Consequently, a lookup operation returns the labeled value directly.
This omission both simplifies implementation, omits a source of label creep, improves runtime performance by eliding label joins, and permits a prototype implementation in WebKit's JIT (Chapter~\ref{sec:jitflow}).
...
\subsection{Simple Math Operations}

\FlowCore\ focuses its capabilities on labeling 

TODO: also take a look at the unit tests to see what statements are covered.
TODO: grab the jitflow paper and read what it says about implementing math operations.
...
All objects accept the bracket notation for field-lookup, however, JavaScript arrays come equipped with specific semantics.


JavaScript arrays derive their functionality from 
