...
Additionally, tracking of active implicit flows demands in joining the label of the current program counter to incorporate the current security context (Chapter~\ref{sec:control-flow-stack}).
