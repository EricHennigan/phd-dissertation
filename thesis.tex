...
\usepackage{tikz}
\usetikzlibrary{arrows,backgrounds,calc,chains,decorations.markings,decorations.pathmorphing,decorations.pathreplacing,fit,positioning,shapes,shapes.multipart,shapes.symbols}
...
\lstset{
language=JavaScript,                             % Code langugage
